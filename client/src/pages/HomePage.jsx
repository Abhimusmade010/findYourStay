  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-16 sm:pt-28 sm:pb-20">

          <motion.h1
            className="text-4xl sm:text-6xl font-bold tracking-tight text-center text-gray-900"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          >
          ...
          <motion.p
            className="mt-5 text-center text-lg text-gray-500 max-w-2xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}
          >
